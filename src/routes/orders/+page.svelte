	...
	{#if data.orders.length === 0}
		<Card>
			<CardContent class="py-12 text-center">
				...
				<p class="mt-1 text-sm text-muted-foreground/70">Kunjungi katalog produk untuk mulai berbelanja</p>
				<a href="/"><Button class="mt-4" variant="outline">Lihat Produk</Button></a>
			</CardContent>
		</Card>
	{:else}
		<div class="space-y-3">
