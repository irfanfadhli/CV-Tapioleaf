...
<div class="flex min-h-screen items-center justify-center p-4 bg-background">
	<Card class="w-full max-w-md shadow-sm">
		<CardHeader class="text-center">
			<div class="mx-auto mb-4 flex h-16 w-16 items-center justify-center overflow-hidden rounded-full bg-primary">
				<picture>
					<source srcset="/img/logo.webp" type="image/webp" />
					<img src="/img/logo.png" alt="TapioLeaf" class="h-full w-full object-cover" width="64" height="64" loading="lazy" decoding="async" />
				</picture>
			</div>
			<CardTitle class="text-xl">CV TapioLeaf</CardTitle>
			<CardDescription>Masuk untuk mulai berbelanja dan mengelola pesanan</CardDescription>
		</CardHeader>
		<CardContent>
			<Button variant="outline" class="w-full gap-2" onclick={signInGoogle}>
